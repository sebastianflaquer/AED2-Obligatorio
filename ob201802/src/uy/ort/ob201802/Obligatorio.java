...
public class Obligatorio {
    ...
    public static void main(String[] args) {
        ...
        s.inicializarSistema(10, -34.897518, -56.164655);
...
//        p.ver(s.registrarAfiliado("8.888.888-8", "Ocho", "gmail.com").resultado, Retorno.Resultado.ERROR_2, "NO agrego Afiliado POR MAIL INVALIDO");
        ...
        p.ver(s.registrarAfiliado("4.517.335-3", "Ocho", "r@gmail.com").resultado, Retorno.Resultado.ERROR_1, "NO agrego Afiliado POR CEDULA INVALIDA");
        ...
        p.ver(s.registrarCanalera("A", "3.333.333-3", PuntoAx, PuntoAy).resultado, Retorno.Resultado.OK, "Registrar Canalera AAA");
        p.ver(s.registrarCanalera("B", "4.444.444-4", PuntoBx, PuntoBy).resultado, Retorno.Resultado.OK, "Registrar Canalera BBB");
        p.ver(s.registrarCanalera("C", "5.555.555-5", PuntoCx, PuntoCy).resultado, Retorno.Resultado.OK, "Registrar Canalera CCC");
        ...
        p.ver(s.registrarNodo("nodoIdE", PuntoEx, PuntoEy).resultado, Retorno.Resultado.OK, "Registrar Nodo E");
        p.ver(s.registrarNodo("nodoIdF", PuntoFx, PuntoFy).resultado, Retorno.Resultado.OK, "Registrar Nodo F");
        p.ver(s.registrarNodo("nodoIdG", PuntoGx, PuntoGy).resultado, Retorno.Resultado.OK, "Registrar Nodo G");
        
        //REGISTRAR NODO ERROR
        System.out.print( "Registrar Nodo ERROR: \n");
        p.ver(s.registrarNodo("Esimposhible", -32.3105144,-58.0759555).resultado, Retorno.Resultado.OK, "Registrar Nodo Error cantidad maxima de puntos");
        
        //REGISTRAR TRAMO
        System.out.print( "Registrar Tramo: \n");
        p.ver(s.registrarTramo(PuntoEx, PuntoFx, PuntoEy, PuntoFy, 10).resultado, Retorno.Resultado.OK, "Registrar Tramo entre Nodo E y Nodo F");
        p.ver(s.registrarTramo(PuntoFx, PuntoGx, PuntoFy, PuntoGy, 10).resultado, Retorno.Resultado.OK, "Registrar Tramo entre Nodo F y Nodo G");
        
        System.out.print( "Registrar Tramo Con Error: \n");
        p.ver(s.registrarTramo(PuntoSx, PuntoAx, PuntoSy, PuntoAy, 10).resultado, Retorno.Resultado.ERROR_4, "Registrar Tramo Sitema y Canalera");
        ...
        p.ver(s.modificarTramo(PuntoEx, PuntoFx, PuntoEy, PuntoFy, 15).resultado, Retorno.Resultado.OK, "Modificar Tramo Nodo E - Nodo F");
        p.ver(s.modificarTramo(PuntoFx, PuntoGx, PuntoFy, PuntoGy, 15).resultado, Retorno.Resultado.OK, "Modificar Tramo Nodo F - Nodo G");
        
        System.out.print( "Modificar Tramo Error: \n");
        p.ver(s.modificarTramo(PuntoEx, PuntoAx, PuntoEy, PuntoAy, 15).resultado, Retorno.Resultado.ERROR_2, "Modificar Tramo Que no existe");
