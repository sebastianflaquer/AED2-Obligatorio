...
public class TestsSistema {
	...
	@Test
	public void testDeshabilitarNodoError(){
		ISistema sistema = new Sistema();
		sistema.inicializarSistema(20, 0.0, 0.0);
		armarMapa(sistema);

		// Deshabilito dos veces el mismo nodo
		assertEquals(Retorno.Resultado.OK, sistema.deshabilitarNodo(-3.0, -3.0).resultado);
		assertEquals(Retorno.Resultado.ERROR_3, sistema.deshabilitarNodo(-3.0, -3.0).resultado);
		// Deshabilito un nodo que no existe
		assertEquals(Retorno.Resultado.ERROR_1, sistema.deshabilitarNodo(-1891.0, -1891.0).resultado);
		// Deshabilito un punto que no es un nodo
		assertEquals(Retorno.Resultado.ERROR_2, sistema.deshabilitarNodo(-13.0, -13.0).resultado);
		
	}
	
	@Test
	public void testCalidadCanaleraDeshabilitarNodo(){
		ISistema sistema = new Sistema();
		sistema.inicializarSistema(20, 0.0, 0.0);
		armarMapa(sistema);
		// Canalera 42
		...
		assertEquals(Retorno.Resultado.OK, sistema.deshabilitarNodo(-2.0, -2.0).resultado);
		// Canalera 42
		r = sistema.calidadCanalera(-42.0, -42.0);
		assertEquals(Retorno.Resultado.OK, r.resultado);
